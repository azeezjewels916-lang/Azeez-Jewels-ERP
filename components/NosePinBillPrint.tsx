...
interface NosePinBillPrintProps {
  billNo: string;
  billDate: string;
...
export const NosePinBillPrint: React.FC<NosePinBillPrintProps> = ({
  billNo,
  billDate,
  saleType,
  customer,
  ...
  return (
    <div className={`nosepin-bill-container ${isScreenPreview ? 'preview-mode' : ''}`}>
      <style>{`
        @media print {
      ...
      `}</style>
      <div className="nosepin-bill-outer relative overflow-hidden">
        ...
        <div className="nosepin-bill-inner">
          ...
          <div className="nosepin-header-top">
            ...
            <div className="nosepin-badge">{saleType === 'GST' ? 'TAX INVOICE / NOSE PIN BILL' : 'NOSE PIN CASH BILL'}</div>
          ...
          {/* BRAND HEAD */}
          <div className="nosepin-brand-section">
            <div className="ahs-badge-wrap">
              <img src="/logowithoutbg.png" alt="AHS Logo" className="w-full h-full object-contain" />
            </div>
            <h1 className="nosepin-title">Azeez Jewels</h1>
            <div className="nosepin-subtitle">Gold, Diamond & Silver Nose Pins & Ornaments</div>
            <div className="nosepin-address-line">
              No. 324, Jumma Masjid Road (O.P.H. Road) Shivaji Nagar, Bangalore - 51
            </div>
            <div className="nosepin-address-line" style={{ fontSize: '8.5px', marginTop: '1px' }}>
              Email : azmathkhan7676@gmail.com
            </div>
          </div>

          {/* CUSTOMER & BILL META */}
          <div className="nosepin-cust-meta">
          ...
          {/* TERMS & CONDITIONS */}
          <div className="nosepin-disclaimer" style={{ fontSize: '7.5px', lineHeight: '1.2' }}>
            <div className="font-bold uppercase text-[8px] mb-0.5">Terms & Conditions:</div>
            • No exchange or return for Nose Pin (due to health & hygiene reasons)<br />
            • No guarantee for stones, colour change or enameling | Exchange within 2 days with original bill<br />
            • Resale / Exchange as per market rate of the day | Additional charges for repair & custom fitting
          </div>

          {/* SIGNATURES */}
          <div className="nosepin-signatures">
