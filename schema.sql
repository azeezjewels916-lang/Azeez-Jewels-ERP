...
CREATE TABLE IF NOT EXISTS bill_items (
    ...
    making_charges NUMERIC DEFAULT 0,
    making_charges_type TEXT DEFAULT 'amt',
    making_charges_input TEXT,
...
ALTER TABLE gold_exchanges ALTER COLUMN purity TYPE TEXT USING purity::text;
...
ALTER TABLE gold_exchanges ADD COLUMN IF NOT EXISTS gst_rate NUMERIC DEFAULT 0;
ALTER TABLE gold_exchanges ADD COLUMN IF NOT EXISTS gst_amount NUMERIC DEFAULT 0;
...
-- NEW COLUMNS FOR MAKING CHARGES
ALTER TABLE bill_items ADD COLUMN IF NOT EXISTS making_charges_type TEXT DEFAULT 'amt';
ALTER TABLE bill_items ADD COLUMN IF NOT EXISTS making_charges_input TEXT;
